...
main = do
    ...
    out 2 sc l $ {-# SCC "earEx"     #-} earExcision p
    out 3 sc l $ {-# SCC "naiveTri"  #-} naiveTri p
    out 4 sc l $ {-# SCC "monoTri"   #-} monoTri p
    out 5 sc l $ {-# SCC "garey"     #-} garey p
    out 6 sc l $ {-# SCC "ketTri"    #-} ketTri p
    -- For some reason my auto type checker is freaking out when these
    -- '>>' aren't there so...
