...
Die Fl�che eines Polygons wird nach Theorem 1.4.3 aus
...
|extreme| ermittelt den extremalen Punkt des konvexen Polygons |p| bez�glich des
...
F�r konvexe Polygone ist der Test auf Enthaltensein einfach, zuerst die naive Methode, die
