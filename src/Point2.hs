...
\Index{orientation} ermittelt die Orientierung des Punktes \texttt{r} bez�glich
...
{-
Anm. Der kollineare Fall mu� f�r Flie�kommazahlen mit $\varepsilon$-Umgebungen
...
clockwise3 [x,y]          = [x,y]
clockwise3 xs@[x,y,z]         
  = case orientation x y z of
      CounterClockwise -> [x,z,y]
      Collinear -> extremaBy leftOrBelow xs
      Clockwise -> xs
clockwise3 _  
  = error "clockwise3 for more than three points"

cclockwise3 []              = []
cclockwise3 [x]              = [x]
cclockwise3 [x,y]          = [x,y]
cclockwise3 xs@[x,y,z]        
  = case orientation x y z of
      CounterClockwise -> xs
      Collinear -> extremaBy leftOrBelow xs
      Clockwise -> [x,z,y]      
cclockwise3 _              
  = error "cclockwise3 for more than three points"
